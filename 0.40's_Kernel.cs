...
namespace CosmosKernelTest
{
    public class Kernel : Sys.Kernel
    {
        ...
        protected override void BeforeRun()
        {
            ...
            Console.Beep(440, 444);
            Console.WriteLine("Welcome to AquaOS");
            Console.Beep(422, 888);
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine("Aqua OS Version 0.40        ______  ______  __  __  ______  ______  ______   ");
            Console.WriteLine("Powered by Cosmos          /\\  __ \\/\\  __ \\/\\ \\/\\ \\/\\  __ \\/\\  __ \\/\\  ___\\  ");
            Console.WriteLine("Options:                   \\ \\  __ \\ \\ \\/\\_\\ \\ \\_\\ \\ \\  __ \\ \\ \\/\\ \\ \\___  \\ ");
            Console.WriteLine("1: Boot Aqua OS normally    \\ \\_\\ \\_\\ \\___\\_\\ \\_____\\ \\_\\ \\_\\ \\_____\\/\\_____\\ ");
            Console.WriteLine("2: Boot without FileSystem   \\/_/\\/_/\\/___/_/\\/_____/\\/_/\\/_/\\/_____/\\/_____/");
            ...
            if (option.Contains("ms-dos"))
            {
                ...
                Console.Write("C:\\>");
                Console.ReadLine();
                Console.WriteLine("Starting AquaOS.exe...");
            ...
            else if (option.Contains("1"))
            {
                ...
                Console.WriteLine("Aqua OS version 0.40 by Kai Howard.");
            ...
            else
            {
                ...
                Console.ForegroundColor = ConsoleColor.Blue;
                Console.Write("AquaOS @ nowhere (reboot now!!): ");
                Console.ReadLine();
        ...
        protected override void Run()
        {
            try
            {
                ...
                {
                    Console.ForegroundColor = ConsoleColor.DarkCyan;
                    Console.WriteLine("AquaOS version 0.40 by Kai Howard");
                }
                else
                {
                    if (input == "")
